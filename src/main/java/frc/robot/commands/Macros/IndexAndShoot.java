...
public class IndexAndShoot extends ParallelCommandGroup {
    ...
    private static double SPEED = 12000.0;
    ...
    public IndexAndShoot(Intake intake, HorizIndexer horizIndexer, VertIndexer vertIndexer, Shooter shooter, Double waitTimeSeconds, Double speed) {
        super(
            new Shoot(shooter, speed),
            new SequentialCommandGroup(
                // new HorizIndexRevCycle(horizIndexer),

...
/*
    * The secondary revision of th trajectory auton group codenamed `Argentina`
*/

public class Alpha_Rev2 extends SequentialCommandGroup {

    public Alpha_Rev2(Drivetrain drivetrain, Intake intake, HorizIndexer horizIndexer, VertIndexer vertIndexer, Shooter shooter, Trajectory firstTrajectory, Trajectory secondTrajectory, Trajectory thirdTrajectory) {
        super(
            ...
            // ? Turn to face goal
            new TurnToAngleProfiled(drivetrain, 165),

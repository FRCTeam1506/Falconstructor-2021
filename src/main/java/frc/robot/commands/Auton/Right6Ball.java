...
public class Right6Ball extends SequentialCommandGroup {
    public Right6Ball(Drivetrain drivetrain, Intake intake, HorizIndexer horizIndexer, VertIndexer vertIndexer, Shooter shooter, Trajectory firstTrajectory, Trajectory secondTrajectory, Trajectory thirdTrajectory) {
        super(

            // ? Drive backwards to get better angle for shooting
            new TankDrive(drivetrain, -0.5, -0.5).withTimeout(0.75),
            ...
            new ParallelCommandGroup(
                ...
                new IndexAndShoot(intake, horizIndexer, vertIndexer, shooter, 2.0, 20_000.0) // 20000.0
            ).withTimeout(5.5),

...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new POVButton(operator, Constants.Playstation.NorthPOVButton.getID()).whileHeld(new First(climber, drivetrain, intake, horizIndexer, vertIndexer, shooter));
    new POVButton(operator, Constants.Playstation.WestPOVButton.getID()).whileHeld(new Second(climber, intake, horizIndexer, vertIndexer, shooter));
    new POVButton(operator, Constants.Playstation.SouthPOVButton.getID()).whileHeld(new Third(climber, intake, horizIndexer, vertIndexer, shooter));
    new POVButton(operator, Constants.Playstation.EastPOVButton.getID()).whileHeld(new Last(climber, intake, horizIndexer, vertIndexer, shooter));
